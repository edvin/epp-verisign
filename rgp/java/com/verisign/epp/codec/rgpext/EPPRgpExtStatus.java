...
public class EPPRgpExtStatus implements EPPCodecComponent {


    /**
     * Log4j category for logging
     */
    private static Logger cat = Logger.getLogger(EPPRgpExtStatus.class.getName(),
   ...
   */
    ...
    /** XML Element Name of <code>EPPRgpExtStatus</code> root element. */
    final static java.lang.String ELM_NAME = "rgp:rgpStatus";

    /**
     * XML Element Status Attribute Name of <code>EPPRgpExtStatus</code> root
     * element.
     */
    ...
    /**
     * Create a new instance of EPPRgpExtStatus with the given
     * status
    ...
    public Element encode(Document aDocument) throws EPPEncodeException {
        ...
        try {
            ...
            cat.error("EPPRgpExtStatus.doEncode(): Invalid state on encode: "
                      + e);
            throw new EPPEncodeException("EPPRgpExtStatus invalid state: "
                                         + e);
        }
     ...
     *
     * @param aObject <code>EPPRgpExtStatus</code> instance to compare with
     *
    ...
    public boolean equals(Object aObject) {
        ...
        // lang
        if (! ( (lang == null) ? (theComp.lang == null) :
               lang.equals(theComp.lang)
               )) {
            return false;
        }
    ...
    /**
     * Validate the state of the <code>EPPRgpExtStatus</code> instance. A
    ...
    /**
     * Clone <code>EPPRgpExtStatus</code>.
     *
     * @return clone of <code>EPPRgpExtStatus</code>
     *
