 ...
 * 
 * @see com.verisign.epp.codec.jobscontact.EPPJobsContactCreateCmd
 */
public class EPPJobsContactCreateCmd implements EPPCodecComponent {

	/**
	 * Log4j category for logging
	 */
	private static Logger cat = Logger.getLogger(EPPJobsContactCreateCmd.class.getName(),
			EPPCatFactory.getInstance().getFactory());

	/**
	 * Constant for the JobsContact create extension tag
	 */
	public static final String ELM_NAME = EPPJobsContactExtFactory.NS_PREFIX + ":create";
	...
	/**
	 * Create an <code>EPPJobContactCreateCmd</code> instance
	 */
	 ...
	 */
	public EPPJobsContactCreateCmd(String aTitle, String aWebsite, String aIndustryType, String aIsAdminContact, String aIsAssociationMember) {
		this.title= aTitle;
	...
	/**
	 * Clone <code>EPPJobsContactCreateCmd</code>.
	 * 
	 * @return clone of <code>EPPJobsContactCreateCmd</code>
	 * @exception CloneNotSupportedException
	 *                standard Object.clone exception
	 */
	public Object clone() throws CloneNotSupportedException {

		EPPJobsContactCreateCmd clone = null;

		clone = (EPPJobsContactCreateCmd) super.clone();

		return clone;
	}

	/**
	 * Checks whether the mandatory fields are set/ intialized
	 * 
	 * @throws EPPEncodeException
	 */
	void validateState() throws EPPEncodeException{		
		if (website == null){
			throw new EPPEncodeException("EPPJobsContact.encode(): Required website attribute is null");
		}else if (isAdminContact == null){
			throw new EPPEncodeException("EPPJobsContact.encode(): Required isAdminContact attribute is null");
		}		
	}
	...
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		try {
			...
			cat.error("EPPJobsContactCreateCmd.doEncode(): Invalid state on encode: " + e);
			throw new EPPEncodeException("EPPJobsContactCreateCmd invalid state: " + e);
		}
	...
	public boolean equals(Object aObject) {
		...
		if (!(aObject instanceof EPPJobsContactCreateCmd)) {
			return false;
		}

		EPPJobsContactCreateCmd theComp = (EPPJobsContactCreateCmd) aObject;
