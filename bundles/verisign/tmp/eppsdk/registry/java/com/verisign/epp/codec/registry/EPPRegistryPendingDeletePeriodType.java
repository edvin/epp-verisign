...
public class EPPRegistryPendingDeletePeriodType extends EPPRegistryPeriodType {
	private static final long serialVersionUID = -6555265301828497885L;

	/**
	 * XML Element Name of <code>EPPRegistryPendingDeletePeriodType</code> root
	 * element.
	 */
	public static final String ELM_NAME = "registry:pendingDelete";
	 ...
	 * {@link EPPRegistryPendingDeletePeriodType}: {@code number} must be
