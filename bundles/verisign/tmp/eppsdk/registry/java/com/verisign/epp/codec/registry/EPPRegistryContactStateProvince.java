 ...
 */
public class EPPRegistryContactStateProvince extends EPPRegistryMinMaxLength {
	/** DOCUMENT ME! */
	private static final long  serialVersionUID = -7713513426049924809L;

	/** DOCUMENT ME! */
	public static final String ELM_NAME = "registry:sp";
	 ...
	 */
	public EPPRegistryContactStateProvince(Integer min, Integer max) {
		this();
		this.min     = min;
		this.max     = max;
	}
	 ...
	 * @param max DOCUMENT ME!
	 */
	public EPPRegistryContactStateProvince(int min, int max) {
