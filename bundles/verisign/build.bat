...
set LOCALCLASSPATH=%JAVA_HOME%\lib\tools.jar;%JAVA_HOME%\lib\dev.jar;%LIB%\xercesImpl-2.6.0.jar;%LIB%\xmlParserAPIs-2.6.0.jar;%ANT_LIB%\ant-launcher-1.7.1.jar;%ANT_LIB%\ant-1.7.1.jar;%ANT_LIB%\ant-junit-1.7.1.jar;%LIB%\junit-3.8.1.jar;%LIB%\jsse.jar
