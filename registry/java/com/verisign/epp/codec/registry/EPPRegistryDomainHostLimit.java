 ...
 */
public class EPPRegistryDomainHostLimit extends EPPRegistryMinMax {
	/** DOCUMENT ME! */
	private static final long  serialVersionUID = -116316160919820797L;

	/** DOCUMENT ME! */
	public static final String ELM_NAME = "registry:childHost";
	 ...
	 */
	public EPPRegistryDomainHostLimit(Integer min, Integer max) {
		this();
		this.min     = min;
		this.max     = max;
	}
