...
/**
 * The <code>SyncDomainHandler</code> class is a concrete implementation of the
 * abstract <code>com.verisign.epp.framework.EPPSyncDomainHandler</code> class. It
...
public class SyncDomainHandler extends EPPDomainHandler {
	...
	private static Logger cat =
		Logger.getLogger(
						 SyncDomainHandler.class.getName(),
						 EPPCatFactory.getInstance().getFactory());

	/**
	 * Constructs an instance of SyncDomainHandler
	 */
	public SyncDomainHandler() {}
	 ...
	 * 		  <code>EPPSyncDomainHandler</code> This is assumed to be an instance
	 * 		  of SessionData here.
	 *
	 ...
	 * @param aEvent The <code>EPPEvent</code> that is being handled
	 * @param aData Any data that a Server needs to send to this
	 * 		  <code>EPPSyncDomainHandler</code>
	 *
	 * @exception EPPHandleEventException Thrown if an error condition occurs.
	 * 			  It must contain an <code>EPPEventResponse</code>
	 */
	...
	protected EPPEventResponse doDomainUpdate(EPPEvent aEvent, Object aData) {
        ...
        // Get the sync update extension
        EPPSyncExtUpdate syncUpdate = (EPPSyncExtUpdate)
            theMessage.getExtension(EPPSyncExtUpdate.class);
        ...
        if (syncUpdate != null) {
            ...
            int day = syncUpdate.getDay();
            int month = syncUpdate.getMonth();
